...
<c:catch var="attributeNotFoundException">
    ...
    <jsp:useBean id="defaultClearingSummaryText" class="java.lang.String" scope="request" />
...
require(['jquery', 'modules/sw360Validate', 'modules/confirm' ], function($, sw360Validate, confirm) {
    ...
    function submitForm() {
        ...
        disableClearingSummaryTextIfNecessary();
    ...
    function disableClearingSummaryTextIfNecessary() {
        if($('#clearingSummaryText').val() == $('#clearingSummaryText').data("defaulttext")) {
            $('#clearingSummaryText').prop('disabled', true);
        }
    }
});
</script>

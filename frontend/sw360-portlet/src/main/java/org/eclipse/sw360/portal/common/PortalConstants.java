...
public class PortalConstants {
    ...
    public static final String DEFAULT_CLEARING_SUMMARY_TEXT = "defaultClearingSummaryText";
    public static final String DEFAULT_LICENSE_INFO_HEADER_TEXT_FOR_DISPALY = "--default text--";
    public static final String DEFAULT_CLEARING_SUMMARY_TEXT_FOR_DISPALY = "--default text--";
